...
<div class="content-wrapper">
  ...
  <section class="content">
    <?php if ($this->session->flashdata('pesan')): ?><?= $this->session->flashdata('pesan'); ?>
    <?php endif; ?>
	<div class="row">
	    <div class="col-md-12">
	        <div class="box" style="border-top: 2px solid #302b63; box-shadow: 0 2px 20px rgb(139, 139, 139);">
                <div class="box-header with-border">
					<?php if($this->session->userdata('level') == 'Petugas'){?>
                    <a href="data/bukutambah"><button class="btn" style="background-color: #302b63; color:white;">
                        ...
                        <?php $no=1;foreach($buku->result_array() as $isi){?>
                            <tr>
                                ...
                                <td><?= $isi['tgl_masuk'];?></td>
									...
									<button class="btn" style="background-color: #302b63; color:white;"><i class="fa fa-sign-in"></i> Detail</button></a>
                                    <a href="<?= base_url('data/prosesbuku?buku_id='.$isi['id_buku']);?>" onclick="return confirm('Anda yakin Buku ini akan dihapus ?');">
									<button class="btn btn-danger" style="margin-top:5px"><i class="fa fa-trash"></i></button></a>
									<?php }else{?>
										<a href="<?= base_url('data/bukudetail/'.$isi['id_buku']);?>">
										<button class="btn"style="background-color: #302b63; color:white;"><i class="fa fa-sign-in"></i> Detail</button></a>
									<?php }?>
