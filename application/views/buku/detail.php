					...
					<table class="table table-striped table-bordered">
						...
						<tr>
							...
							<td>
								...
								?> 
								<a data-toggle="modal" data-target="#TableAnggota" class="btn btn-xs" style="margin-left:1pc; background-color: #302b63; color:white;">
						...
						<tr>
							...
							<td><?php if(!empty($buku->lampiran !== "0")){?>
									<a href="<?= base_url('assets_style/image/buku/'.$buku->lampiran);?>" class="btn btn-md" target="_blank" style="background-color: #302b63; color:white;">
