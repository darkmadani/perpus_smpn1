...
<div class="wrapper">
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo base_url('index.php/dashboard'); ?>" class="logo" style="background: #302b63; border-right: 1px solid grey;">
        <span class="logo-mini">
          <img src="<?php echo base_url('assets_style/image/SMPN2.png'); ?>" alt="" style="width: 30px; height: 30px;">
        </span>
        <span class="logo-lg">PERPUS SOLDU</span>
      </a>

      <!-- Navbar -->
      <nav class="navbar navbar-static-top" style="background: #302b63;">
        <!-- Sidebar toggle button-->
        <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button" style="background:transparent;">
          <span class="sr-only">Toggle navigation</span>
        </a>
        
        <form class="navbar-form navbar-left" action="<?= base_url('search'); ?>" method="post">
          <div class="form-group">
            <input type="text" name="keyword" class="form-control" placeholder="Cari buku" autocomplete="off" autofocus required>
          </div>
