			    ...
			    <div class="box-body">
                    <form action="<?php echo base_url('user/upd');?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <img src="<?= base_url('assets_style/image/'.$user->foto);?>" class="img-responsive" alt="#" style="width: 25%;">
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                        ...
                        <div class="pull-right">
                            <button type="submit" class="btn btn-md" style="background:#302b63;color:white">Edit Data</button> 
						</form>
						<?php if($this->session->userdata('level') == 'Petugas'){?>
