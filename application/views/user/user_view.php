	    ...
	    <div class="col-md-12">
	        <div class="box" style="border-top: 2px solid #302b63; box-shadow: 0 2px 20px rgb(139, 139, 139);">
                <div class="box-header with-border">
                    <a href="user/tambah"><button class="btn" style="background-color: #302b63; color:white;"><i class="fa fa-plus"> </i> Tambah User</button></a>
                        ...
                        <?php $no=1;foreach($user as $isi){?>
                            <tr>
                                ...
                                <td style="width:20%;">
									...
									<a href="<?= base_url('user/detail/'.$isi['id_login']);?>" target="_blank"><button class="btn" style="margin-top:5px; background-color: #302b63; color:white;">
