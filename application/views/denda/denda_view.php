					...
					<div class="box" style="border-top: 2px solid #302b63; box-shadow: 0 2px 20px rgb(139, 139, 139);">
						...
						<div class="box-body">
							...
							<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
								...
								<button type="submit" class="btn" style="background-color: #302b63; color:white;"><i class="fa fa-edit"></i> Edit Harga Denda</button>
							</form>
							<?php }else{?>
							...
							<form method="post" action="<?= base_url('transaksi/dendaproses');?>">
								...
								<button type="submit" class="btn" style="background-color: #302b63; color:white;"> <i class="fa fa-plus"></i> Tambah Harga Denda</button>
							</form>
							<?php }?>
						</div>
					</div>
