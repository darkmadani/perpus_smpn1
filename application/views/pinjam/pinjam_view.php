	    ...
	    <div class="col-md-12">
	        <div class="box" style="border-top: 2px solid #302b63; box-shadow: 0 2px 20px rgb(139, 139, 139);">
                <div class="box-header with-border"><?php if($this->session->userdata('level') == 'Petugas'){ ?>
                    <a href="transaksi/pinjam"><button class="btn" style="background-color: #302b63; color:white;">
                            ...
                            <tr>
								...
								<td style="text-align:center;">
									<?php if($this->session->userdata('level') == 'Petugas'){ ?>
										...
										<?php }?>
										<a href="<?= base_url('transaksi/detailpinjam/'.$isi['pinjam_id'].'?pinjam=yes');?>" class="btn btn-sm" title="detail pinjam" style="background-color: #302b63; color:white;"><i class="fa fa-eye"></i></button></a>
